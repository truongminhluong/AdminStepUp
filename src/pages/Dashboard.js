  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout>
        ...
        <Content style={{ margin: "10px", padding: "20px" }}>
          {selectedTab === "dashboard" && (
            <>
              <Row gutter={16}>
                <Col span={8}>
                  <Card>
                    <Statistic title="Users" value={1200} prefix={<UserOutlined />} />
                  </Card>
                </Col>
                <Col span={8}>
                  <Card>
                    <Statistic title="Orders" value={320} prefix={<ShoppingCartOutlined />} />
                  </Card>
                </Col>
                <Col span={8}>
                  <Card>
                    <Statistic title="Revenue" value={56000} prefix={<DollarOutlined />} />
                  </Card>
                </Col>
              </Row>
